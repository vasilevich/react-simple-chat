...
var Header = function Header(_ref) {
  ...
  }, headerAvatar && React__default.createElement("div", {
  ...
  }, title ? title : 'Chat Demo')), React__default.createElement("img", {
...
var Timestamp = function Timestamp(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    style: style
  }, React__default.createElement(Moment, {
    format: "dd. o HH:mm"
  }, moment(date)));
};
...
var Body = function Body(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    }, isTimeStamp && message.createdAt ? React__default.createElement(Timestamp, {
      date: message.createdAt,
      style: timestampStyle
    }) : null, React__default.createElement("div", {
      className: "chat-body__message"
    }, message.user.avatar && isAvatarVisible && React__default.createElement(Avatar, {
      source: message.user.avatar
    }), message.user.avatar && !isAvatarVisible && React__default.createElement("div", {
      style: {
        marginLeft: '30px'
      }
  ...
  }, typingUserAvatar !== undefined && React__default.createElement(Avatar, {
    source: typingUserAvatar
  }), React__default.createElement(TypingIndicator, null)), React__default.createElement("div", {
    ref: el
  }));
};
...
var Input = function Input(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    ref: el,
    style: inputStyle
  }), value.length > 0 && React__default.createElement("img", {
...
var Chat = function Chat(_ref) {
  ...
  var _useState = React.useState(minimized),
      isMinimized = _useState[0],
      setIsMinimized = _useState[1];

  return React__default.createElement(React__default.Fragment, null, isMinimized ? React__default.createElement(Widget, {
...
//# sourceMappingURL=react-simple-chat.cjs.development.js.map
